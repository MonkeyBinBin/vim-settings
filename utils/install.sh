...
hash git >/dev/null && /usr/bin/env git clone https://github.com/MonkeyBinBin/vim-settings ~/.vim || {
...
echo ""
echo "\033[0;34mGithub Repository: https://github.com/MonkeyBinBin/vim-settings\033[0m"
echo ""
